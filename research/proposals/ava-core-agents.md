...
3. **Write an IOR** to `reflections/` if the session produced a durable
   insight. Follow governance/template-reflections.md. Pass all 8 quality gates (G1-G8).
...
Every IOR follows governance/template-reflections.md. The three sections:
...
definitions, governance/template-reflections.md, and the new governance layer. Procedures
