...
- The IOR writing standard (`governance/template-reflect.md`)
...
7. **IOR Writing** (per governance/template-reflect.md):
...
| No explicit IOR quality gates | G1-G8 from governance/template-reflect.md enforced |
