...
- The IOR writing standard (`governance/template-reflections.md`)
...
7. **IOR Writing** (per governance/template-reflections.md):
...
| No explicit IOR quality gates | G1-G8 from governance/template-reflections.md enforced |
