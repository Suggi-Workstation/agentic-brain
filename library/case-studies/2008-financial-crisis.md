...
The crisis produced the most sweeping financial legislation since the
1930s. The Dodd-Frank Wall Street Reform and Consumer Protection Act
of 2010 created the Consumer Financial Protection Bureau (CFPB), the
Financial Stability Oversight Council (FSOC), and the Orderly
Liquidation Authority for failing systemically important institutions.
It required supervisory and company-run stress tests for covered firms,
the Volcker Rule restricting proprietary trading by insured
depositories and affiliates, and new derivatives clearing and reporting
requirements. The Federal Reserve's CCAR process began in 2011 as a
...
home prices and underwriting deterioration. In a broad crisis,
correlations can rise sharply, so diversification that works against
...
- `library/finance/financial-statement-analysis.md` -- red flags and
  forensic techniques that would have surfaced warning signs in the
  financial statements of leveraged institutions.
- `library/case-studies/anchor-case-studies.md` -- the domain anchor
  defining the case-study framework and adjacent domain boundaries.
- `library/accounting-financial-shenanigans/anchor-accounting-financial-shenanigans.md`
  -- techniques for detecting the aggressive accounting and off-balance-
  sheet vehicles that hid leverage from investors during the crisis.
- `library/portfolio-risk-management/anchor-portfolio-risk-management.md`
  -- the risk management frameworks that failed during the crisis and
  the lessons for constructing resilient portfolios.
- `library/law-regulation/anchor-law-regulation.md` -- the regulatory
  framework governing financial institutions, including Dodd-Frank and
  Basel III.
