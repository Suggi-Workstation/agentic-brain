---
name: journalism-and-media-ethics
id: 20260829T130342Z
tier: library-topic
...
### The SPJ Four Principles

The most influential codification of American journalism ethics is the
Society of Professional Journalists Code of Ethics, revised September 6,
2014, which organizes its guidance under four principles. First, seek
truth and report it: journalism should be accurate and fair, and
journalists should be honest and courageous in gathering, reporting,
and interpreting information -- verifying information before releasing
it, using original sources whenever possible, and never plagiarizing or
deliberately distorting facts or context. Second, minimize harm: ethical
journalism treats sources, subjects, colleagues, and the public as human
beings deserving of respect, balancing the public's need for
information against potential harm, and using heightened sensitivity
with juveniles, victims of sex crimes, and sources who cannot give
informed consent. Third, act independently: the highest and primary
obligation of ethical journalism is to serve the public, which means
refusing gifts, favors, and special treatment and avoiding conflicts of
interest, real or perceived. Fourth, be accountable and transparent:
journalists should explain ethical choices and processes to audiences,
respond quickly to questions about accuracy, and acknowledge mistakes
...
a fundamental principle of journalism; it is a device that becomes
deceptive when reporters use it to launder their own opinions through
selected sources. A journalist who picks sources to express a personal
point of view and then wraps the result in the neutral voice is engaged
in what they call a form of deception that damages the credibility of
the whole profession. They contrast this discipline with what they
name the journalism of assertion: the default posture of the
always-on digital news stream, in which claims are published on the
strength of assertion, aggregation, and repetition rather than
corroborated evidence. The discipline of verification, they argue, is
the best antidote to assertion-driven media, because it gives citizens
...
Few ethical questions are more entangled with law than the use of
anonymous sources, and the SPJ Ethics Committee's position paper on the
subject is blunt: keep a promise of confidentiality and a journalist may
face a grand jury, a judge, and a jail cell; break it and the journalist
may face a lawsuit. The professional standard is equally clear: identify
sources whenever feasible, because the public is entitled to as much
information as possible about a source's reliability, and use anonymous
sources only as a last resort. The SPJ code contains two pointed
statements: identify sources whenever feasible, and always question
sources' motives before promising anonymity. The Australian tradition,
articulated in the MEAA Journalist Code of Ethics, adds the same
...
The minimize-harm principle operationalizes the idea that the pursuit
of news is not a license for arrogance or undue intrusiveness. Its
working rules include: balance the public's need for information against
potential harm; show compassion for those affected by coverage; use
heightened sensitivity with juveniles and victims of sexual crimes;
recognize that legal access to information differs from an ethical
justification to publish; and grant private people a greater right to
control information about themselves than public figures who seek
power, influence, or attention. The classic application is tragedy
...
Acting independently means serving the public first, and it translates
into concrete prohibitions: refuse gifts, favors, fees, free travel,
and special treatment; avoid political and other outside activities
that may compromise integrity or impartiality; avoid conflicts of
interest, real or perceived; and disclose unavoidable conflicts.
Independence also extends to the boundary between journalism and
commerce: the SPJ code requires journalists to distinguish news from
advertising and to shun hybrids that blur the lines between the two,
and to distinguish advocacy from news reporting, labeling analysis and
...
The fourth SPJ principle closes the loop. Accountability requires
responding quickly to questions about accuracy, clarity, and fairness;
...
1. Society of Professional Journalists. "SPJ Code of Ethics." Revised
   September 6, 2014, at the SPJ National Convention, Nashville,
   Tennessee. https://www.spj.org/spj-code-of-ethics [high]

2. Society of Professional Journalists Ethics Committee. "Position
   Paper: Anonymous Sources."
   https://www.spj.org/spj-ethics-committee-position-papers-anonymous-sources [high]

3. Kovach, B. & Rosenstiel, T. "The Essence of Journalism Is a
   Discipline of Verification." Excerpt from The Elements of Journalism
   (Crown, 2001; rev. 2014), published by Nieman Reports.
   https://niemanreports.org/the-essence-of-journalism-is-a-discipline-of-verifications/ [high]

4. Commission on Freedom of the Press (Hutchins Commission). A Free
   and Responsible Press. University of Chicago Press, 1947. Full text
   at Internet Archive: https://archive.org/details/in.ernet.dli.2015.30183 [high]

5. Encyclopaedia Britannica. "Hutchins Commission."
   https://www.britannica.com/topic/Hutchins-Commission [medium]

6. Brenan, M. "Americans' Trust in Media Remains at Trend Low." Gallup,
   October 14, 2024.
   https://news.gallup.com/poll/651977/americans-trust-media-remains-trend-low.aspx [high]

7. Gallup. "Trust in Media at New Low of 28% in U.S." October 2, 2025.
...
9. Postma, L., De Jong, J., & Opgenhaffen, M. (2026). "Sourcing News
   ...
   Covering the Israel-Gaza War's Beginning." Journalism Practice.
   https://doi.org/10.1080/17512786.2026.2679483 [high]

10. Zamith, R. "Professional Codes of Ethics." In The American
...
- `library/communication/the-medium-is-the-message.md` -- how media
  form shapes the content journalism ethics regulates.
- `library/communication/rhetoric.md` -- the persuasion toolkit that
