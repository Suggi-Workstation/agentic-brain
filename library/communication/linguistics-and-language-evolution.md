---
name: linguistics-and-language-evolution
id: 20260830T064723Z
tier: library-topic
...
1. Britannica. "Sir William Jones." Encyclopaedia Britannica.
   https://www.britannica.com/biography/William-Jones-British-orientalist-and-jurist [high]

2. Britannica. "Comparative linguistics." Encyclopaedia Britannica.
   https://www.britannica.com/print/article/129646 [high]

3. Britannica. "Grimm's law." Encyclopaedia Britannica.
   https://www.britannica.com/topic/Grimms-law [high]

4. Kte'pi, B. (2021). "Linguistic relativity (Sapir-Whorf
   hypothesis)." EBSCO Research Starters.
   https://www.ebsco.com/research-starters/language-and-linguistics/linguistic-relativity-sapir-whorf-hypothesis [medium]

5. Cibelli, E., Xu, Y., Austerweil, J. L., Griffiths, T. L., & Regier,
   T. (2016). "The Sapir-Whorf hypothesis and probabilistic inference:
...
7. Bouckaert, R. et al. (2012). "Mapping the origins and expansion of
   ...
   https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4112997/ [high]
...
9. Max Planck Institute for Evolutionary Anthropology (2023). "New
   ...
   https://www.mpg.de/20666229/new-insights-into-the-origin-of-the-indo-european-languages [high]

10. Knowable Magazine (2024). "A new look at our linguistic roots."
    https://knowablemagazine.org/content/article/society/2024/origin-spread-indo-european-languages [medium]
...
15. Dabrowska, E. (2015). "What exactly is Universal Grammar, and has
    anyone seen it?" Frontiers in Psychology 6:852.
    https://pmc.ncbi.nlm.nih.gov/articles/PMC4477053 [high]

16. Vicario, C. M. (2013). "FOXP2 gene and language development: the
    molecular substrate of the gestural-origin theory of speech?"
...
- `library/communication/rhetoric.md` -- persuasion operates on the
  lexical and grammatical categories linguistics describes.
- `library/communication/narrative-structure-and-storytelling.md` --
  narrative is language's discourse layer; linguistics supplies the
  grammatical substrate stories run on.
- `library/communication/the-medium-is-the-message.md` -- the
  complementary claim that media shape thought; linguistic relativity
  argues the code itself does too.
- `library/communication/propaganda-and-misinformation.md` --
  manipulative communication works by exploiting lexical framing and
  category selection.
- `library/communication/interpersonal-communication-and-negotiation.md` --
