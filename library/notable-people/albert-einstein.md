...
links:
  ...
  - library/notable-people/richard-feynman.md
  - library/science/quantum-mechanics.md
...
- `library/notable-people/marie-curie.md` -- fellow physicist whose
  relentless pursuit of radioactivity reshaped science; a parallel case
  of scientific obsession and personal cost.
- `library/notable-people/richard-feynman.md` -- physicist who extended
  quantum theory through QED and shared Einstein's commitment to
  intellectual honesty and independent thinking.
- `library/science/quantum-mechanics.md` -- the theory Einstein helped
  found and spent decades debating; the full framework behind the
  Bohr-Einstein debates.
- `library/science/scientific-method-falsifiability.md` -- the
  epistemological framework within which Einstein's thought experiments
  and predictive theories operate.
- `library/history/world-war-ii.md` -- the historical context for the
  Einstein-Szilard letter and the Manhattan Project.
- `library/history/cold-war.md` -- the geopolitical context for the
  Russell-Einstein Manifesto and the nuclear arms race.
- `library/geopolitics/nuclear-deterrence-mad.md` -- the strategic
  doctrine that emerged from the nuclear age Einstein's equation
  helped unlock.