...
- The IOR writing standard from governance/template-reflect.md
...
- The old system lacked IOR quality gates. G1-G8 from governance/template-reflect.md
...
5. **Quality gates on IORs are structural improvement.** G1-G8 from
   governance/template-reflect.md makes quality failure falsifiable. The old system
...
- `governance/template-reflect.md` -- the IOR writing standard (G1-G8 quality gates)
