...
- governance/template-reflections.md
- research/insights/ (future: add TrilogyAI article reference)

## v2 -- 2026-07-19 -- Ava

**(ava):** Format corrections applied to match template-reflections.md
specification:
- tier: insight -> reflection
- trigger: narrative -> canonical value
- author: ava -> Ava
