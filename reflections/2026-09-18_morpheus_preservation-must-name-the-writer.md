...
- `reflections/2026-09-05_morpheus_correctness-includes-preservation.md` -- id 20260905T211414Z; preservation remains part of correctness, now made explicit about legitimate concurrent writers.
- `reflections/2026-09-17_morpheus_correct-settings-do-not-prove-transitions.md` -- id 20260917T203201Z; the earlier source-level ownership witness is extended by native failing-before/passing-after tests, not retrospectively relabeled as one.
- `reflections/2026-07-19_ava_defense-in-depth-time-separated-gates.md` -- id 20260719T105602Z; time-separated checks remain useful, while the meaning of the intervening changes must also be specified.
