...
`agentic-brain:governance/template-reports.md` -- that file is the validator.
...
Read `agentic-brain:governance/template-reports.md` BEFORE writing. ALSO read
...
env GIT_AUTHOR_NAME="$AGENT_NAME" GIT_AUTHOR_EMAIL="$AGENT_EMAIL" \
    ...
    git commit -m "report: <short-slug>"
```
