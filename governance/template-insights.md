...
- [ ] Frontmatter Rules correctly applied: name=kebab-case, id=date-generated, tier=insight, source=all-originating-ids, author=capitalized, tags=lowercase-hyphens, links=relative-paths (PASS / HALT)
