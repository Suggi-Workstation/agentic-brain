...
- [ ] `## Background` section present with substantive content -- at least 500 words (G12) (PASS / HALT)
- [ ] `## Core Concepts` section present with essential ideas. Title MAY vary by domain (e.g. `## Core Biases by Category`, `## Core Principles`) but the section MUST exist. Contains substantive content -- at least 1000 words. (G12) (PASS / HALT)
...
- [ ] `## Implications` section present -- why the topic matters, practical application. Contains substantive content -- at least 750 words. (G12) (PASS / HALT)
...
- **G12 -- Mandatory Section Quality:** Each mandatory section
  ...
  substantive, non-trivial content. Minimums: Background 500 words,
  Core Concepts 1000 words, Evidence 750 words, Implications 750
