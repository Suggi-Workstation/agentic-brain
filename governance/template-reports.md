...
- [ ] Frontmatter Schema complete (6 fields: name, id, tier, author, tags, links)  (PASS / HALT)
- [ ] Frontmatter Rules correctly applied (6 fields: name, id, tier, author, tags, links)  (PASS / HALT)
- [ ] id generated by running `date -u +'%Y%m%dT%H%M%SZ'` (not estimated, not rounded)  (PASS / HALT)
- [ ] Executive summary: question + answer + key evidence + confidence  (PASS / HALT)
- [ ] Research question: falsifiable, scoped (in/out)  (PASS / HALT)
- [ ] Methodology: reproducible, sources have retrieval dates, limitations stated  (PASS / HALT)
- [ ] Findings: each with claim + evidence + confidence  (PASS / HALT)
- [ ] Negative results: what was searched for and NOT found  (PASS / HALT)
