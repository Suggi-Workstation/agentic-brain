...
- [ ] Frontmatter Rules correctly applied: name=kebab-case, id=date-generated, tier=proposal, author=capitalized, tags=lowercase-hyphens, links=relative-paths (PASS / HALT)
