...
- [ ] Frontmatter Schema complete: all 6 fields present (PASS / HALT)
- [ ] Frontmatter Rules correctly applied: name=kebab-case, id=date-generated, tier=report, author=capitalized, tags=lowercase-hyphens, links=relative-paths (PASS / HALT)
