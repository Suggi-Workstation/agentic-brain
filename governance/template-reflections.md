...
- [ ] Frontmatter Schema complete (7 fields: name, id, tier, trigger, author, tags, links)  (PASS / HALT)
- [ ] Frontmatter Rules correctly applied (7 fields: name, id, tier, trigger, author, tags, links)  (PASS / HALT)
- [ ] id generated by running `date -u +'%Y%m%dT%H%M%SZ'` (not estimated, not rounded)  (PASS / HALT)
- [ ] Title makes a claim  (PASS / HALT)
- [ ] I section: idea stated in one sentence + context  (PASS / HALT)
- [ ] O section: clear position + confidence level  (PASS / HALT)
